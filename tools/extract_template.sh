...
xgettext *.php */*.php --copyright-holder='Badges Development Team' --package-name='GLPI - Badges plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
