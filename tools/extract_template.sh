...
xgettext *.php */*.php --copyright-holder='Badges Development Team' --package-name='GLPI - Badges plugin' --package-version='1.9.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
