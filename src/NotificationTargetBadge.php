 ...
 */
class NotificationTargetBadge extends NotificationTarget
{
    public const REQUESTER = 30;

    public const BadgesWhichExpire  = "BadgesWhichExpire";
    public const ExpiredBadges      = "ExpiredBadges";
    public const BadgesReturn       = "BadgesReturn";
    public const AccessBadgeRequest = "AccessBadgeRequest";
